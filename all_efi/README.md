...
Ventura 13.7.8 的两套 EFI 已加入 `RTCMemoryFixup.kext` 和 `rtcfx_exclude=58-59,B0-B3,D0-DF`，并已实机验证修复 HP 开机自检时间无效 / `Real Time Clock Power Loss (005)` 问题。安装后建议执行一次 `Reset NVRAM`。
